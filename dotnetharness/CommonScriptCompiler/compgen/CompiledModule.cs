...
namespace CommonScript.Compiler.Internal
{
    public class CompiledModule
    {
        ...
        public CompiledModule(string id, System.Collections.Generic.Dictionary<string, string> codeFiles, System.Collections.Generic.Dictionary<string, AbstractEntity> nestedEntities, System.Collections.Generic.Dictionary<string, AbstractEntity> flattenedEntities, System.Collections.Generic.Dictionary<string, AbstractEntity> entitiesNoEnumParents, System.Collections.Generic.List<AbstractEntity> lambdaEntities)
        {
            this.id = id;
