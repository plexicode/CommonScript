...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public static int[] ExportUtil_exportBundle(string flavorId, string extVersionId, CompilationBundle bundle)
        {
            ...
            ByteStringBuilder modBsb = null;
            string activeModuleId = null;
            i = 1;
            while (i < bundle.functionById.Count)
            {
                BundleFunctionInfo fn = bundle.functionById[i];
                if (fn.moduleId != activeModuleId)
                {
                    activeModuleId = fn.moduleId;
                    modBsb = bsbFromLenString(activeModuleId);
                }
                else
                {
                    modBsb = bsbFromLenString("");
                }
                entityAcc = bsbJoin2(entityAcc, bsbJoin6(modBsb, bsbFromInt(fn.argcMin), bsbFromInt(fn.argcMax), bsbFromLenString(fn.name), bsbFromInt(fn.code.Length), ExportUtil_exportCode(fn.code)));
                i += 1;
            }
            activeModuleId = null;
            i = 1;
            while (i < bundle.lambdaById.Count)
            {
                ...
                entityAcc = bsbJoin2(entityAcc, bsbJoin5(modBsb, bsbFromInt(fn.argcMin), bsbFromInt(fn.argcMax), bsbFromInt(fn.code.Length), ExportUtil_exportCode(fn.code)));
                i += 1;
            }
            i = 1;
        ...
        {
            return "class ResourceModule {\nfield _h;\nconstructor(h) {\nthis._h = h;\n}\n}\n@3ImageResource {\nfield width;\nfield height;\nfield _data;\nconstructor(_data, _w, _h) {\nthis._data = _data;\nthis.width = _w;\nthis.height = _h;\n}\n@1getDataHandle() {\n@4this._data;\n}\n}\nclass Resource@6 {\nconstructor(m) : base(m) { }\n}\n@5getCurrentResourceModule() {\nh = $res_mod_parent();\n@4new ResourceModule(h);\n}\n@1_baseRead(m, p, t) {\nb = [];\ne = $res_read(m, '' + p, t, b);\nif (e != null) throw new ResourceException(e);\n@4b;\n}\n@5readTextResourceAsString(module = null, path) {\n@4_baseRead(module == null ? $res_mod_parent() : module._h, path, 'T')[0];\n}\n@5readBinaryResourceAsBytes(module, path) {\n@4_baseRead(module == null ? $res_mod_parent() : module._h, path, 'B');\n}\n@5readImageResource(module, path) {\nb = _baseRead(module == null ? $res_mod_parent() : module._h, path, 'I');\n@4new ImageResource(b[0], b[1], b[2]);\n}\n@5listAllResources(module = null) {\n@4$res_list(module == null ? $res_mod_parent() : module._h);\n}\n@5getResourceType(module = null, path) {\n@4_baseRead(module == null ? $res_mod_parent() : module._h, path, 'Y')[0];\n}";
        }
